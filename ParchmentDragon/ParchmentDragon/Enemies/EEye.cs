...
namespace ParchmentDragon
{
    class EEye : Enemy
    {
        // This is enemy 3 in the enemy list.
        ...
        public override void Move()
        {
            ...
            if (isLeft && getCenter().Y < 300)
            {
                velocity.X = 2f;
                velocity.Y = -2f;
            }
            else if (!isLeft && getCenter().Y < 300)
            {
                velocity.X = -2f;
                velocity.Y = -2f;
            }
        ...
        public override Enemy Copy()
        {
            ...
            Enemy enemyCopy = new EEye(
                new AnimatedTexture(aliveTex, 75, 30, Vector2.Zero, 0.0f, 1.0f, 0.2f, 15),
